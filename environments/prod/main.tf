# =============================================================================
# EKS Observability Stack - Prod Environment
# =============================================================================
...
locals {
  common_tags = merge(var.common_tags, { Environment = "prod", Project = "eks-observability" })
}
...
module "observability_infra" {
  ...
  monitoring_node_instance_types = ["t3.xlarge"]
  monitoring_node_count          = 3
  monitoring_node_min_count      = 2
  monitoring_node_max_count      = 10
